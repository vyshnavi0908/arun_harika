...
const translations={
  ...
  cordially:['WE CORDIALLY INVITE YOU TO','మిమ్మల్ని సాదరంగా ఆహ్వానిస్తున్నాము'],invitedTitle:['HARIKA & ARUN','హారిక & అరుణ్'],invitedText:['Join us as we celebrate every ritual, every smile and every blessing that leads to our forever.','మా శాశ్వత బంధానికి దారితీసే ప్రతి ఆచారం, ప్రతి చిరునవ్వు మరియు ప్రతి ఆశీర్వాదాన్ని మాతో కలిసి జరుపుకోండి.'],preWedding:['HALDI & SANGEETH','హల్దీ & సంగీత్'],weddingVenue:['WEDDING VENUE','వివాహ వేదిక'],directions:['📍 GET DIRECTIONS','📍 మార్గం చూడండి'],scanVenue:['SCAN FOR WEDDING VENUE','వివాహ వేదిక కోసం స్కాన్ చేయండి'],
...
const eventData=[
 ['💛','HALDI','12 OCTOBER 2026 · 3:00 PM','Skyland, Mandapeta','Ladies & Girls — Yellow · Boys & Gents — White','Ladies & Girls — పసుపు · Boys & Gents — తెలుపు','https://www.google.com/maps/search/?api=1&query=Skyland%2C%20Mandapeta%2C%20Andhra%20Pradesh'],
 ...
 ['👰🏻‍♀️','PELLIKUTHURU FUNCTION','14 OCTOBER 2026 · MUHURTHAM 7:59 AM','Vijayalakshmi Nagar, Lakshmi Sai Sadhan Building, Mandapeta','The auspicious Pellikuthuru function.','శుభ పెళ్లికూతురు కార్యక్రమం.','https://www.google.com/maps/search/?api=1&query=Vijayalakshmi%20Nagar%2C%20Lakshmi%20Sai%20Sadhan%20Building%2C%20Mandapeta%2C%20Andhra%20Pradesh'],
 ['🥁','VEERABHADRUNI BONAM','14 OCTOBER 2026 · 11:00 AM','From Pellikuthuru Function Venue → Veerabhadrudi Temple','A traditional procession to Veerabhadrudi Temple.','పెల్లికూతురు వేదిక నుండి → వీరభద్రుడి ఆలయం వరకు సంప్రదాయ ఊరేగింపు.','https://www.google.com/maps/search/?api=1&query=Veerabhadrudi%20Temple%2C%20Mandapeta%2C%20Andhra%20Pradesh'],
