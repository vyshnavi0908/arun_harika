...
const translations={
  ...
  cordially:['WE CORDIALLY INVITE YOU TO','మిమ్మల్ని సాదరంగా ఆహ్వానిస్తున్నాము'],invitedTitle:['LAKSHMI VENKATA SRI HARIKA & MUTHYALA ARUN KUMAR','లక్ష్మీ వెంకట శ్రీ హారిక & ముత్యాల అరుణ్ కుమార్'],invitedText:['Join us as we celebrate every ritual, every smile and every blessing that leads to our forever.','మా శాశ్వత బంధానికి దారితీసే ప్రతి ఆచారం, ప్రతి చిరునవ్వు మరియు ప్రతి ఆశీర్వాదాన్ని మాతో కలిసి జరుపుకోండి.'],preWedding:['HALDI & SANGEETH','హల్దీ & సంగీత్'],weddingVenue:['WEDDING VENUE','వివాహ వేదిక'],directions:['📍 GET DIRECTIONS','📍 మార్గం చూడండి'],scanVenue:['SCAN FOR WEDDING VENUE','వివాహ వేదిక కోసం స్కాన్ చేయండి'],
...
const eventData=[
 ...
 ['👰🏻‍♀️','PELLIKUTHURU FUNCTION','14 OCTOBER 2026 · MUHURTHAM 7:59 AM','Pellikuthuru Function Venue','The auspicious Pellikuthuru function.','శుభ పెళ్లికూతురు కార్యక్రమం.','https://maps.app.goo.gl/hLj5kpDu4pyynHEc6?g_st=iw'],
 ['🥁','VEERABHADRUNI BONAM','14 OCTOBER 2026 · 11:00 AM','Veerabhadrudi Bonam Venue','A traditional procession to Veerabhadrudi Temple.','పెల్లికూతురు వేదిక నుండి → వీరభద్రుడి ఆలయం వరకు సంప్రదాయ ఊరేగింపు.','https://maps.app.goo.gl/hLj5kpDu4pyynHEc6?g_st=iw'],
