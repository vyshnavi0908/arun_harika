...
const translations={
  brideName:['Lakshmi Venkata Sri Harika','లక్ష్మీ వెంకట శ్రీ హారిక'], groomName:['Muthyala Arun Kumar','ముత్యాల అరుణ్ కుమార్'], footerDate:['14 OCTOBER 2026 · MANDAPETA','14 అక్టోబర్ 2026 · మండపేట'], venueLine:['14 OCTOBER 2026 · SRI KANYA GRAND · MANDAPETA','14 అక్టోబర్ 2026 · శ్రీ కన్యా గ్రాండ్ · మండపేట'], skyland:['Skyland, Mandapeta','స్కైల్యాండ్, మండపేట'], weddingAddress:['Sri Kanya Grand<br>Gollapantha Road, Near AS Grand, Mandapeta','శ్రీ కన్యా గ్రాండ్<br>గొల్లపంత రోడ్, ఏఎస్ గ్రాండ్ సమీపంలో, మండపేట'],
  ...
  noteFromUs:['A NOTE FROM US','మా నుండి ఒక సందేశం'],welcomeTitle:['WELCOME','స్వాగతం'],welcomeText:['With hearts full of joy and gratitude, we invite you to celebrate the beginning of a beautiful new chapter. Your presence, blessings and love will make these precious moments even more special.','ఆనందం మరియు కృతజ్ఞతతో నిండిన హృదయాలతో, మా జీవితంలోని అందమైన కొత్త అధ్యాయానికి మీరు సాక్షులుగా రావాలని ఆహ్వానిస్తున్నాము. మీ సమక్షం, ఆశీస్సులు మరియు ప్రేమ ఈ మధుర క్షణాలను మరింత ప్రత్యేకంగా చేస్తాయి.'],signature:['With love & gratitude,<br><strong>Lakshmi Venkata Sri Harika & Muthyala Arun Kumar</strong>','ప్రేమతో మరియు కృతజ్ఞతలతో,<br><strong>లక్ష్మీ వెంకట శ్రీ హారిక & ముత్యాల అరుణ్ కుమార్</strong>'],govinda:['“Govinda! Govinda! Venkata Ramana Govinda!”','“గోవిందా! గోవిందా! వెంకట రమణ గోవిందా!”'],invocation:['A traditional invocation to Lord Venkateswara','శ్రీ వెంకటేశ్వర స్వామి వారికి సంప్రదాయ ప్రార్థన'],
  ...
  twoHearts:['TWO HEARTS · ONE PROMISE','రెండు హృదయాలు · ఒక వాగ్దానం'],meetCouple:['MEET THE COUPLE','వధూవరులను కలుసుకోండి'],bride:['BRIDE','వధువు'],groom:['GROOM','వరుడు'],brideParents:['D/O Sri Sriramachandra Murthy & Smt. Bagyalakshmi','శ్రీ సీతారామచంద్ర మూర్తి & శ్రీమతి భాగ్యలక్ష్మి గారి కుమార్తె'],groomParents:['S/O Late Sri Muthyala Venkateswara Rao & Smt. Seetha Mahalakshmi','దివంగత శ్రీ ముత్యాల వెంకటేశ్వర రావు & శ్రీమతి సీతా మహాలక్ష్మి గారి కుమారుడు'],
  ...
  cordially:['WE CORDIALLY INVITE YOU TO','మిమ్మల్ని సాదరంగా ఆహ్వానిస్తున్నాము'],invitedTitle:['LAKSHMI & ARUN','లక్ష్మీ & అరుణ్'],invitedText:['Join us as we celebrate every ritual, every smile and every blessing that leads to our forever.','మా శాశ్వత బంధానికి దారితీసే ప్రతి ఆచారం, ప్రతి చిరునవ్వు మరియు ప్రతి ఆశీర్వాదాన్ని మాతో కలిసి జరుపుకోండి.'],preWedding:['HALDI & SANGEETH','హల్దీ & సంగీత్'],weddingVenue:['WEDDING VENUE','వివాహ వేదిక'],directions:['📍 GET DIRECTIONS','📍 మార్గం చూడండి'],scanVenue:['SCAN FOR WEDDING VENUE','వివాహ వేదిక కోసం స్కాన్ చేయండి'],
...
let scratching=false,revealed=false,scratched=0;
function resizeScratch(){
  ...
  revealed=false;scratched=0;card.classList.remove('revealed');canvas.style.pointerEvents='auto';
}
function scratchAt(e){if(revealed)return;const rect=canvas.getBoundingClientRect();const x=e.clientX-rect.left,y=e.clientY-rect.top;ctx.globalCompositeOperation='destination-out';ctx.beginPath();ctx.arc(x,y,28,0,Math.PI*2);ctx.fill();scratched++;if(scratched>35)revealScratch();}
...
const eventData=[
 ['💛','HALDI','12 OCTOBER 2026 · 3:00 PM','Skyland, Mandapeta','Ladies & Girls — Yellow · Boys & Gents — White','Ladies & Girls — పసుపు · Boys & Gents — తెలుపు','https://www.google.com/maps/dir/?api=1&destination=Skyland%2C%20Mandapeta%2C%20Andhra%20Pradesh'],
 ['🕺🏼💃🏼','SANGEETH','12 OCTOBER 2026 · 7:00 PM','Skyland, Mandapeta','An evening of music, dance and celebration.','సంగీతం, నృత్యం మరియు ఆనందోత్సాహాలతో నిండిన సాయంత్రం.','https://www.google.com/maps/dir/?api=1&destination=Skyland%2C%20Mandapeta%2C%20Andhra%20Pradesh'],
 ['👰🏻‍♀️','PELLIKUTHURU FUNCTION','14 OCTOBER 2026 · MUHURTHAM 7:59 AM','Vijayalakshmi Nagar, Lakshmi Sai Sadhan Building, Mandapeta','The auspicious Pellikuthuru function.','శుభ పెల్లికూతురు కార్యక్రమం.','https://www.google.com/maps/dir/?api=1&destination=Vijayalakshmi%20Nagar%2C%20Lakshmi%20Sai%20Sadhan%20Building%2C%20Mandapeta%2C%20Andhra%20Pradesh'],
 ['🥁','VEERABHADRUNI BONAM','14 OCTOBER 2026 · 11:00 AM','From Pellikuthuru Function Venue → Veerabhadrudi Temple','A traditional procession to Veerabhadrudi Temple.','పెల్లికూతురు వేదిక నుండి వీరభద్రుడి ఆలయం వరకు సంప్రదాయ ఊరేగింపు.','https://www.google.com/maps/dir/?api=1&destination=Veerabhadrudi%20Temple%2C%20Mandapeta%2C%20Andhra%20Pradesh'],
 ['💍❤️','THE BIG DAY — WEDDING','14 OCTOBER 2026 · MUHURTHAM 8:29 PM','Sri Kanya Grand, Gollapantha Road, Near AS Grand','The wedding ceremony and the beginning of forever.','వివాహ వేడుక మరియు శాశ్వత బంధానికి శ్రీకారం.','https://www.google.com/maps/dir/?api=1&destination=Sri%20Kanya%20Grand%2C%20Gollapantha%20Road%2C%20Mandapeta%2C%20Andhra%20Pradesh'],
 ['🪷','SATYANARAYANA VRATHAM','15 OCTOBER 2026','Ravulapalem','Time not specified in the supplied invitation details.','సమయం అందించిన ఆహ్వాన వివరాల్లో పేర్కొనబడలేదు.','https://www.google.com/maps/dir/?api=1&destination=Ravulapalem%2C%20Andhra%20Pradesh']
];
const eventTitlesTe={HALDI:'హల్దీ',SANGEETH:'సంగీత్','PELLIKUTHURU FUNCTION':'పెల్లికూతురు కార్యక్రమం','VEERABHADRUNI BONAM':'వీరభద్రుని బోనం','THE BIG DAY — WEDDING':'శుభ వివాహం','SATYANARAYANA VRATHAM':'సత్యనారాయణ వ్రతం'};
...
const eventPlacesTe={'Skyland, Mandapeta':'స్కైల్యాండ్, మండపేట','Vijayalakshmi Nagar, Lakshmi Sai Sadhan Building, Mandapeta':'విజయలక్ష్మి నగర్, లక్ష్మీ సాయి సాధన్ బిల్డింగ్, మండపేట','From Pellikuthuru Function Venue → Veerabhadrudi Temple':'పెల్లికూతురు వేదిక నుండి → వీరభద్రుడి ఆలయం','Sri Kanya Grand, Gollapantha Road, Near AS Grand':'శ్రీ కన్యా గ్రాండ్, గొల్లపంత రోడ్, ఏఎస్ గ్రాండ్ సమీపంలో','Ravulapalem':'రావులపాలెం'};
