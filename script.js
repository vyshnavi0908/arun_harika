...
const translations={
  ...
  moments:['MOMENTS WE TREASURE','మేము మదిలో దాచుకున్న మధుర క్షణాలు'],galleryTitle:['GALLERY','చిత్రాల సమాహారం'],swipe:['SWIPE OR USE THE ARROWS','స్వైప్ చేయండి లేదా బాణాలను ఉపయోగించండి'],presence:['YOUR PRESENCE IS OUR BLESSING','మీ సమక్షమే మా ఆశీర్వాదం'],ceremoniesTitle:['SCHEDULE OF SACRED CEREMONIES','శుభ కార్యక్రమాల వివరాలు'],swipeCeremonies:['SWIPE OR USE THE ARROWS','స్వైప్ చేయండి లేదా బాణాలను ఉపయోగించండి'],engagementTitle:['ENGAGEMENT MOMENTS','నిశ్చితార్థ క్షణాలు'],engagementSubtitle:['A beautiful beginning to our forever','మన శాశ్వత ప్రయాణానికి ఒక అందమైన ఆరంభం'],
...
const eventData=[
 ...
 ['💍❤️','KALYANA MAHOTSAVAM','14 OCTOBER 2026 · MUHURTHAM 8:29 PM','Sri Kanya Grand, Gollapantha Road, Near AS Grand','The wedding ceremony and the beginning of forever.','వివాహ వేడుక మరియు శాశ్వత బంధానికి శ్రీకారం.','https://www.google.com/maps/search/?api=1&query=Sri%20Kanya%20Grand%2C%20Gollapantha%20Road%2C%20Near%20AS%20Grand%2C%20Mandapeta%2C%20Andhra%20Pradesh'],
...
const eventTitlesTe={HALDI:'హల్దీ',SANGEETH:'సంగీత్','PELLIKUTHURU FUNCTION':'పెళ్లికూతురు కార్యక్రమం','VEERABHADRUNI BONAM':'వీరభద్రుని బోనం','KALYANA MAHOTSAVAM':'కళ్యాణ మహోత్సవం','SATYANARAYANA VRATHAM':'సత్యనారాయణ వ్రతం'};
const eventDatesTe={HALDI:'12 అక్టోబర్ 2026 · మధ్యాహ్నం 3:00',SANGEETH:'12 అక్టోబర్ 2026 · సాయంత్రం 7:00','PELLIKUTHURU FUNCTION':'14 అక్టోబర్ 2026 · ముహూర్తం ఉదయం 7:59','VEERABHADRUNI BONAM':'14 అక్టోబర్ 2026 · ఉదయం 11:00','KALYANA MAHOTSAVAM':'14 అక్టోబర్ 2026 · ముహూర్తం రాత్రి 8:29','SATYANARAYANA VRATHAM':'15 అక్టోబర్ 2026'};
