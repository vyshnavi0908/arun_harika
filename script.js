...
const translations={
  ...
  noteFromUs:['A NOTE FROM US','మా నుండి ఒక సందేశం'],welcomeTitle:['WELCOME','స్వాగతం'],welcomeText:['With hearts full of joy and gratitude, we invite you to celebrate the beginning of a beautiful new chapter. Your presence, blessings and love will make these precious moments even more special.','ఆనందం మరియు కృతజ్ఞతతో నిండిన హృదయాలతో, మా జీవితంలోని అందమైన కొత్త అధ్యాయానికి మీరు సాక్షులుగా రావాలని ఆహ్వానిస్తున్నాము. మీ సమక్షం, ఆశీస్సులు మరియు ప్రేమ ఈ మధుర క్షణాలను మరింత ప్రత్యేకంగా చేస్తాయి.'],signature:['With love & gratitude,<br><strong>Harika & Arun Kumar</strong>','ప్రేమతో మరియు కృతజ్ఞతలతో,<br><strong>హారిక & అరుణ్ కుమార్</strong>'],govinda:['“Govinda! Govinda! Venkata Ramana Govinda!”','“గోవిందా! గోవిందా! వెంకట రమణ గోవిందా!”'],invocation:['A traditional invocation to Lord Venkateswara','శ్రీ వెంకటేశ్వర స్వామి వారికి సంప్రదాయ ప్రార్థన'],
...
const eventData=[
 ['💛','HALDI','12 OCTOBER 2026 · 3:00 PM','Skyland, Mandapeta','Ladies & Girls — Yellow<br>Boys & Gents — Yellow & White','Ladies & Girls — పసుపు<br>Boys & Gents — పసుపు మరియు తెలుపు','https://www.google.com/maps/search/?api=1&query=Skyland%2C%20Mandapeta%2C%20Andhra%20Pradesh'],
 ...
 ['👰🏻‍♀️','PELLIKUTHURU FUNCTION','14 OCTOBER 2026 · MUHURTHAM 7:59 AM','Vijayalakshmi Nagar, Lakshmi Sai Sadhan Building, Mandapeta','The auspicious Pellikuthuru function.','శుభ పెళ్లికూతురు కార్యక్రమం.','https://maps.app.goo.gl/hLj5kpDu4pyynHEc6?g_st=iw'],
 ['🥁','VEERABHADRUNI BONAM','14 OCTOBER 2026 · 11:00 AM','From Pellikuthuru Function Venue → Veerabhadrudi Temple','A traditional procession to Veerabhadrudi Temple.','పెల్లికూతురు వేదిక నుండి → వీరభద్రుడి ఆలయం వరకు సంప్రదాయ ఊరేగింపు.','https://maps.app.goo.gl/hLj5kpDu4pyynHEc6?g_st=iw'],
